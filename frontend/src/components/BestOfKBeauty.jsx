...
const BestOfKBeauty = () => {
 const { products } = useContext(ShopContext);
   const [KBeautyProduct, setKBeautyProducts] = useState([]);
   const navigate = useNavigate();
 
   useEffect(() => {
     setKBeautyProducts(products.slice(3, 8)); // Show 5 products
   }, [products]);
...
>
  <Title text1={"Best of"} text2={"K-Beauty"} />
  <button
