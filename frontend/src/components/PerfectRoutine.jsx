...
const PerfectRoutine = () => {
  const { products } = useContext(ShopContext);
  const [PerfectProduct, setPerfectProducts] = useState([]);
  const navigate = useNavigate();

  useEffect(() => {
    setPerfectProducts(products.slice(2, 7)); // Show 5 products
  }, [products]);
...
>
  <Title text1={"Find your "} text2={"Perfect Routine"} />
  <button
